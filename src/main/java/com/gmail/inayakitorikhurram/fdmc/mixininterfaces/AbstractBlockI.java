...
public interface AbstractBlockI {
    ...
    default int getWeakRedstonePower4(BlockState state, BlockView world, BlockPos pos, Direction4 dir){
        return 0;
    }
    default int getStrongRedstonePower4(BlockState state, BlockView world, BlockPos pos, Direction4 dir){
        return 0;
    }
}
