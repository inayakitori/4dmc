...
public interface NeighbourUpdaterI{
    ...
    static void replaceWithStateForNeighborUpdate(WorldAccess world, Direction4Enum direction4, BlockState neighborState, BlockPos pos, BlockPos neighborPos, int flags, int maxUpdateDepth) {
