...
public interface WorldAccessI
    ...
    default void replaceWithStateForNeighborUpdate(Direction4Enum direction4, BlockState neighborState, BlockPos pos, BlockPos neighborPos, int flags, int maxUpdateDepth) {
    ...
    void updateNeighborsExcept4(BlockPos pos, Block sourceBlock, Direction4Enum direction);
}
